                    ...
                    <div class="d-flex align-items-end row">
                      <div class="col-7">
                        <div class="card-body text-nowrap">
                          ...
                          <h4 class="text-primary mb-1"><?=currency_sym();?>0k</h4>
                        ...
                        <div class="row gy-3">
                          ...
                          <div class="col-md-3 col-6">
                            <div class="d-flex align-items-center">
                              ...
                              <div class="card-info">
                                <h5 class="mb-0"><?=currency_sym()?>9745</h5>
                                <small>Revenue</small>
                              </div>
                            </div>
                          </div>
                      ...
                      <div class="card h-100">
                        ...
                        <div class="card-body">
                          ...
                          <div class="mt-3 text-center">
                            <small class="text-muted mt-3"><?=currency_sym()?>21k Expenses more than last month</small>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="card-body p-0">
                      <div class="row row-bordered g-0">
                        ...
                        <div class="col-md-4 p-4">
                          ...
                          <h3 class="text-center pt-8 mb-0"><?=currency_sym()?>25,825</h3>
                      ...
                      <ul class="p-0 m-0">
                        <li class="d-flex align-items-center mb-5">
                          ...
                          <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                            ...
                            <div class="user-progress d-flex align-items-center gap-4">
                              <small><?=currency_sym()?>1,619</small>
                        ...
                        <li class="d-flex align-items-center mb-5">
                          ...
                          <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                            ...
                            <div class="user-progress d-flex align-items-center gap-4">
                              <small><?=currency_sym()?>3,571</small>
                              <div class="d-flex align-items-center gap-1">
                                <i class="ti ti-chevron-up text-success"></i>
                        ...
                        <li class="d-flex mb-6">
                          ...
                          <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                            ...
                            <div class="user-progress d-flex align-items-center gap-1">
                              <p class="mb-0"><?=currency_sym()?>999.29</p>
                            </div>
                          </div>
                        </li>
                        <li class="d-flex mb-6">
                          ...
                          <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                            ...
                            <div class="user-progress d-flex align-items-center gap-1">
                              <p class="mb-0"><?=currency_sym()?>72.40</p>
                            </div>
                          </div>
                        </li>
                        <li class="d-flex mb-6">
                          ...
                          <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                            ...
                            <div class="user-progress d-flex align-items-center gap-1">
                              <p class="mb-0"><?=currency_sym()?>99</p>
                            </div>
                          </div>
                        </li>
                        <li class="d-flex mb-6">
                          ...
                          <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                            ...
                            <div class="user-progress d-flex align-items-center gap-1">
                              <p class="mb-0"><?=currency_sym()?>249.99</p>
                            </div>
                          </div>
                        </li>
                        <li class="d-flex mb-6">
                          ...
                          <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                            ...
                            <div class="user-progress d-flex align-items-center gap-1">
                              <p class="mb-0"><?=currency_sym()?>79.40</p>
                            </div>
                          </div>
                        </li>
                        <li class="d-flex">
                          ...
                          <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                            ...
                            <div class="user-progress d-flex align-items-center gap-1">
                              <p class="mb-0"><?=currency_sym()?>129.48</p>
                            </div>
                          </div>
                        </li>
                      </ul>
                      ...
                      <ul class="p-0 m-0">
                        <li class="d-flex mb-3 pb-1 align-items-center">
                          ...
                          <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                            ...
                            <div class="user-progress d-flex align-items-center gap-1">
                              <h6 class="mb-0 text-danger">-<?=currency_sym()?>75</h6>
                            </div>
                          </div>
                        </li>
                        <li class="d-flex mb-3 pb-1 align-items-center">
                          ...
                          <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                            ...
                            <div class="user-progress d-flex align-items-center gap-1">
                              <h6 class="mb-0 text-success">+<?=currency_sym()?>480</h6>
                            </div>
                          </div>
                        </li>
                        <li class="d-flex mb-3 pb-1 align-items-center">
                          ...
                          <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                            ...
                            <div class="user-progress d-flex align-items-center gap-1">
                              <h6 class="mb-0 text-success">+<?=currency_sym()?>268</h6>
                            </div>
                          </div>
                        </li>
                        <li class="d-flex mb-3 pb-1 align-items-center">
                          ...
                          <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                            ...
                            <div class="user-progress d-flex align-items-center gap-1">
                              <h6 class="mb-0 text-danger">-<?=currency_sym()?>699</h6>
                            </div>
                          </div>
                        </li>
                        <li class="d-flex mb-3 pb-1 align-items-center">
                          ...
                          <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                            ...
                            <div class="user-progress d-flex align-items-center gap-1">
                              <h6 class="mb-0 text-success">+<?=currency_sym()?>98</h6>
                            </div>
                          </div>
                        </li>
                        <li class="d-flex mb-3 pb-1 align-items-center">
                          ...
                          <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                            ...
                            <div class="user-progress d-flex align-items-center gap-1">
                              <h6 class="mb-0 text-success">+<?=currency_sym()?>126</h6>
                            </div>
                          </div>
                        </li>
                        <li class="d-flex align-items-center">
                          ...
                          <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                            ...
                            <div class="user-progress d-flex align-items-center gap-1">
                              <h6 class="mb-0 text-danger">-<?=currency_sym()?>1290</h6>
                            </div>
                          </div>
                        </li>
                      </ul>
