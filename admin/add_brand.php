                        ...
                        <div class="mb-6 col">
                          ...
                          <select name="company_id" id="company_id" class="form-control">
                            <?php
                              ...
                              $getCompanyDropdown = getCompanyDropdown();
                              // var_dump($getCompanyDropdown);
                              // die();
                              foreach ($getCompanyDropdown as $code => $codeVal) { ?>
                                  <option value="<?=$code;?>" <?= (isset($brand['company_id'])) ? ((($brand['company_id'] == $code) ? ('selected') : ("") )) : (""); ?> ><?=$codeVal;?></option> 
                              <?php } ?>
                            </select>
                        </div>
                      </div>
