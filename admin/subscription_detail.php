  ...
  $subscription_data = get_single_subscription($subscription_id);
  $statusLabel = (($subscription_data['active'] == 1) ? ("bg-label-success") : ("bg-label-warning")) ;
  $statusText = (($subscription_data['active'] == 1) ? ("Published") : ("Draft")) ;
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <div
                ...
                <div class="d-flex flex-column justify-content-center">
                  <div class="mb-1">
                    <span class="h5">Order #<?php echo $subscription_data['id'] ? $subscription_data['id'] : "N/A"; ?> </span><span class="badge bg-label-success me-1 ms-2">Paid</span>
                    <span class="badge bg-label-info"><?=$statusText?></span>
                  </div>
                  <p class="mb-0"><?= system_date_format($subscription_data['created_at']); ?></p>
                </div>
                    ...
                    <div class="card-datatable table-responsive">
                      <table class="datatables-products table" id="example">
                        ...
                        <tbody class="table-border-bottom-0">
                              ...
                              ?>
                              <tr>
                                <td><?php echo $subscription_data['package_id'] ? get_single_package($subscription_data['package_id'])['name'] : "N/A"; ?></td>
                                <td><?php echo $subscription_data['user_id'] ? get_single_user($subscription_data['user_id'])['uname'] : "N/A"; ?></td>
                                <td>$<?php echo $subscription_data['price'] ? number_format((float)$subscription_data['price'], 2, '.', '') : "0"; ?></td>
                              </tr>
                      ...
                      <div class="d-flex justify-content-end align-items-center m-6 mb-2">
                        <div class="order-calculations">
                          <div class="d-flex justify-content-start mb-2">
                            ...
                            <h6 class="mb-0">$<?php echo $subscription_data['price'] ? number_format((float)$subscription_data['price'], 2, '.', '') : "0"; ?></h6>
                          </div>
                  ...
                  <div class="card mb-6">
                    ...
                    <div class="card-body">
                      <div class="d-flex justify-content-start align-items-center mb-6">
                        ...
                        <div class="d-flex flex-column">
                          <a href="app-user-view-account.html" class="text-body text-nowrap">
                            <h6 class="mb-0"><?php echo $subscription_data['billings_name'] ? $subscription_data['billings_name'] : "N/A"; ?></h6>
                          </a>
                      ...
                      <div class="d-flex justify-content-start align-items-center mb-6">
                        ...
                        ></span>
                        <h6 class="text-nowrap mb-0"><?php echo $subscription_data['billings_zip'] ? $subscription_data['billings_zip'] : " "; ?> - <?php echo $subscription_data['billings_country'] ? $subscription_data['billings_country'] : " "; ?></h6>
                      </div>
                      ...
                      <p class="mb-1">Email: <?php echo $subscription_data['billings_email'] ? $subscription_data['billings_email'] : "N/A"; ?></p>
                      <p class="mb-0">Country: <?php echo $subscription_data['billings_country'] ? $subscription_data['billings_country'] : "N/A"; ?></p>
                    </div>
                  </div>
