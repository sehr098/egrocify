                  ...
                  <table class="datatables-products table" id="example">
                    ...
                    <tbody class="table-border-bottom-0">
                         ...
                         <?php
                          ...
                          ?>
                          <tr>
                            <td style="visibility: hidden;"><?php echo $row['sorting'] ? $row['sorting'] : "N/A"; ?></td>
                            <td><?php echo $row['name'] ? $row['name'] : "N/A"; ?></td>
                            <td><?php echo $row['short_description'] ? $row['short_description'] : "-"; ?></td>
                            <td><?php echo $row['description'] ? $row['description'] : "-"; ?></td>
                            <td><?=currency_sym()?><?php echo $row['price'] ? $row['price'] : "0"; ?></td>
                            <td><?php echo $row['referal_reward'] ? $row['referal_reward'] : "0"; ?></td>
                            <td><?php echo $row['withdraw_limit'] ? $row['withdraw_limit'] : "0"; ?></td>
