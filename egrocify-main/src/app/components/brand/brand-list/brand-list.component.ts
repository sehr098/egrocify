...
export class BrandListComponent {
  ...
  columns: ColumnDefinition[] = [
    { key: 'id', header: 'ID' },
    { key: 'company', header: 'Brand', backgroundColor: 'orange', textColor: 'black', customdiv: true },
    { key: 'slug', header: 'Company', backgroundColor: 'purple', textColor: 'black', customdiv: true },
