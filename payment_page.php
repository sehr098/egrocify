...
$package = get_single_package($_POST['pkg_id']);
$user_id = 0;
  $payment_mode = $_POST['payment_mode'];

if(isset($_SESSION['loggedin_id'])){
  $user_id = $_SESSION['loggedin_id'];
  $user_name = $_SESSION['loggedin_name'];
  $user_email = $_SESSION['loggedin_email'];
}
if(isset($_POST['user_id'])){
  $get_user_det = get_user_det($_POST['user_id']);
...
// var_dump($package);
$order_id = get_last_subs_id();
// $order_id = get_last_order_id();
$month_limit = 1;
if(isset($_POST['month_limit'])){
    ...
    <section class="section-py bg-body first-section-pt">
      <div class="container">
        <div class="card px-3">
          ...
          <form id="createSubscriptionForm" class="mb-3" action="../ajax-request.php" method="POST" >
            <div class="row">
            ...
            <input type="hidden" name="subscription-request" value="1">
          </form>
        </div>
      </div>
    </section>
 ...
 <script type="text/javascript">
  $(document).ready(function() {
        ...
        $.ajax({
          ...
          success: function(data) {
            if(data.success == 1){
                ...
                // window.location.href = "/thankyou.php?ord_id="+data.ord_id;
            }
            else{
                alert(data.msg);
            }
    ...
    $("#month_limit").change(function(){
      var payment_mode = "<?=$_POST['payment_mode']?>";
      var pkg_id = "<?=$_POST['pkg_id']?>";
